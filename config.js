...
const telenor_message_api_tps = 35;
const telenor_subscription_api_tps = 15;
const telenor_subscriber_query_api_tps = 8;
const telenor_free_mbs_api_tps = 2;
...
let config = {
    development: {
        port: '5000',
        mongoDB: 'mongodb://localhost:27017/goonjpaywall-ap',
