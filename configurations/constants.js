...
class Constants {
    constructor({}) {
        ...
        this.message_after_repeated_succes_charge = {
            QDfC: `Goonj tv Rs.5 ap ka mobile balance sa renew kr de gae ha. Daikhny ka lye click goonj.pk or Khatam krny ka lye https://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`,
            QDfG: `Goonj tv Rs.15 ap ka mobile balance sa renew kr de gae ha. Daikhny ka lye click goonj.pk or Khatam krny ka lye https://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`,                            
        ...
        this.message_after_first_successful_charge = {
            QDfC: `Goonj daily Live TV service Rs.5/day istamal krny ka shukria. Service dekhein goonj.pk or Unsub krny ka liya https://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`,
            QDfG: `Goonj weekly Live TV service Rs.15/week istamal krny ka shukria. Service dekhein goonj.pk or Unsub krny ka liya https://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`,                           
            QDfH: `Ap Pakistan ki best Comedy Portal service istamal kar rahey hain. Service Deikhnay ya Package ki tabdeeli k liay click karein. https://goonj.pk/home`,
            QDfI: `Ap Pakistan ki best Comedy Portal service istamal kar rahey hain. Service Deikhnay ya Package ki tabdeeli k liay click karein. https://goonj.pk/home`
        }
        this.message_on_weekly_to_daily_switch = {
            message: `Ap abi Goonj Weekly k subscriber hain. Validity %current_date% khatam hony k bad ap ko Rs.5+tax/day %next_date% pr shift kr dia jy ga. Khatam krny k liye http://goonj.pk/unsubscribe?proxy=%user_id%&amp;pg=%pkg_id%`
        }
    }
